...
public interface ArtSellerController {

  @Operation(
      summary = "Returns Art",
      description = "Returns all art being sold by a supplied seller",
      responses = {
      ...
      parameters = {
          @Parameter(name = "seller",
            allowEmptyValue = false,
            required = true,
            description = "The Art seller (i.e., 'ArtDistributor')"),
      }
  )
  @GetMapping
  @ResponseStatus(code = HttpStatus.OK)
  List<Art> fetchArtBySeller(@RequestParam String seller);
}